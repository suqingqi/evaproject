...
> **如何利用已有配方数据，在 LOI、UL-94 和透光率存在性能权衡的情况下，减少盲目试配，并推荐更值得进行下一轮实验的配方？**
...
模型选择完成后，使用全部 100 组当前混合来源配方记录重新训练最终模型，用于候选配方预测。
...
> **利用已有配方数据缩小配方搜索空间，并帮助研发人员决定下一批最值得做的实验。**
